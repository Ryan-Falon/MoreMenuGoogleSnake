window.snake.more_menu = function() {
  ...
  // 13
  img = new Image;
  img.src = 'https://www.rd.com/wp-content/uploads/2019/08/Fruit-pattern-of-red-apple-on-blue-background.-Flat-lay-top-view.-Pop-art-design-creative-summer-concept.-Food-background-scaled.jpg?resize=700,466';
  img.width = 47;
  img.height = 47;
  ...
  // 25
  img = new Image;
  img.src = 'https://i.pinimg.com/736x/c8/b1/0e/c8b10e6fa6fb9ceb768c0f0074b5c8d3--apple-vector-vector-graphics.jpg';
  img.width = 47;
  img.height = 47;
  document.querySelector('#count').appendChild(img);
  ...
  // 87
  img = new Image;
  img.src = 'https://cdn.w600.comps.canstockphoto.com/appel-crate-87-stock-photograph_csp11674599.jpg';
  img.width = 47;
  img.height = 47;
  document.querySelector('#count').appendChild(img);
  ...
  // apple bomb
  img = new Image;
  img.src = 'https://i1.sndcdn.com/avatars-000691943786-devrcy-t500x500.jpg';
  img.width = 47;
  img.height = 47;
  document.querySelector('#count').appendChild(img);
  ...
  // apple nuke
  img = new Image;
  img.src = 'https://i.postimg.cc/4ybrKSPb/i-Nuke-LMAO.png';
  img.width = 47;
  img.height = 47;
  document.querySelector('#count').appendChild(img);
